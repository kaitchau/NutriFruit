const FruitFunFacts = {
  ...
  banana: [
    "Banana plants are not trees, they are actually giant herbs",
    ...
    "Research shows that eating bananas can assist learning",
  ...
  kiwi: [
    "People allergic to latex are highly likely to also be allergic to kiwi fruit",
  ...
  strawberry: [
    ...
    "Strawberries were used as sacred symbols by Christian stonemasons",
